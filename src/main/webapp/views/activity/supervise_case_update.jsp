...
$(function(){
	...
	jqueryUtil.formValidate({
		...
		rules:{
			...
			caseId:{required:true,maxlength:25,remote:{
				url:'${path}/activity/supervise_case/check_name',
				type:'post',
				data:{
					superviseId:function(){return $('#superviseId').val();}
				}
			}},
...
<form:form id="showForm" action="${path}/activity/supervise_case/o_update" enctype="multipart/form-data">
	<input type="hidden" id="superviseId" name="superviseId" value="${superviseCase.superviseId }"></input>
	<table width="90%" class="table_add">
		...
		<tr>
			...
			<td width="80%" style="text-align: left;">
				<input type="text" class="text"  id="caseName"  name="caseName" value="${superviseCase.caseName }"/>
				<font color="red">*必填</font>
			</td>
		</tr>
		<tr>
			...
			<td width="30%" style="text-align: left;">
				<textarea id="content" name="content">${superviseCase.content }</textarea>
			</td>
		</tr>
		<tr>
