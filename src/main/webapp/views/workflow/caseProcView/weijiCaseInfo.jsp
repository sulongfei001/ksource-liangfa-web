...
<tr>
	...
	<c:if test="${caseInfo.caseDetailFileName!=null && caseInfo.caseDetailFileName!=''}">
		<a href="${path}/download/weijicaseDetail/${caseInfo.caseId}">${caseInfo.caseDetailFileName}</a>
	</c:if>
	</td>
</tr>
<tr>
...
<script type="text/javascript">
	...
	$('#forCasePartyWarn${CaseParty.partyId}')
			.html(
					[
							'&nbsp;<a style="color:red" title="当事人存在历史案件" href="javascript:showWeijiCasePartyHistoryCase(',
							"'${path}','${CaseParty.wjCaseId}','${CaseParty.idsNo}','${CaseParty.name}')",
