...
<fieldset class="fieldset" >
	<legend class="legend">行政区划修改</legend>
		<form:form id="addForm" action="${path}/system/district/o_update" method="post">
			<input type="hidden" class="text" id="districtCode" name="districtCode" value="${district.districtCode }">
			<table width="90%" class="table_add">
				...
				<tr>
					...
					<td width="80%" style="text-align:left;">
						<input type="text" id="districtName" name="districtName" class="text" value="${district.districtName }"/>
				...
				<tr>
					...
					<td width="80%" style="text-align:left;">
						<input type="text" id="serial" name="serial" class="text" value="${district.serial }"/>
						<font color="red">*必填</font>
					</td>
				</tr>
			</table>
