...
<div>
<p class="address">你所在的位置：<a class="font_12_0075b8" href="javascript:home(1);">首页</a> >>${channel.name }</p>
<div class="sjz_w739 fl">
<div class="lfltmenunew2"><h3 class="fl">${channel.name }</h3></div>
<div class="sjz_listcont1">
	<display:table name="contents" cellspacing="0" cellpadding="0" uid="content" requestURI="${path }/cms/explore/selectContentMain">
