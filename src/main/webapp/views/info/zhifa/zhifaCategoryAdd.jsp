...
$(function(){
	...
	jqueryUtil.formValidate({
    	...
    	blockUI:false,
    	rules:{
    		typeName:{required:true,maxlength:25,remote:'${path}/info/zhifaInfoType/checkName'}
    	},
    	messages:{
...
<body>
<div class="panel">
		<form:form id="addForm" action="${path }/info/zhifaInfoType/add">
