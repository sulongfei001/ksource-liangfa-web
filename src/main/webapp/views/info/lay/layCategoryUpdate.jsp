	...
	jqueryUtil.formValidate({
    	...
    	rules:{
    		typeName:{
    		    ...
    		    maxlength:25,
    		    remote:{
    			    url:'${path}/info/layType/checkName',
    			    type:'post',
    			    data:{
...
<body>
<div class="panel">
		<form:form id="updateForm" action="${path}/info/layType/update">
			<input type="hidden" class="text" id="typeId" name="typeId" value="${infoType.typeId}" />
			<table style="width: 90%;" class="table_add">
				<tr>
					<td width="30%"  class="tabRight">类型名称：</td>
					<td width="70%" align="left">
						<input type="text" class="text" name="typeName" value="${infoType.typeName}"/>&nbsp;<font color="red">*必填</font>
					</td>
				</tr>
			</table>
