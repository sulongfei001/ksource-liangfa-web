...
<script type="text/javascript">
    ...
    function openStatis(){
    	var url = "http://localhost:8088/liangfa-stat/manage/login-sso.do?userId=${currUser.userId}&pwd=${currUser.password}";
    	window.open(url);
    }
	...
	function loadDaibanCount(){
		...
		$.post(url,function(data){
			...
			$("#transferDetentionTodoNum").text(obj.transferDetentionTodoNum);
			$("#lianSupTodoNum").text(obj.lianSupTodoNum);
		});
	}
	...
	function reloadData(){
		if('tabitem1' == navtab.getSelectedTabItemID()){
			//首次进入用户首页，ajax载入全部模块
/* 			$.each(portalModule, function(i, module) {
				loadPortal(module);
			}); */
			//加载待办数量
		   	loadDaibanCount();
...
<script id="jierudanwei-tpl-1" type="text/template">
   	 全省接入公安机关<span class="redcolor">!{policeNum}</span>家，<br>
	省级<span class="redcolor">!{provicePoliceNum}</span>家，<br>
	市级<span class="redcolor">!{cityPoliceNum}</span>家，<br>
	县级<span class="redcolor">!{countyPoliceNum}</span>家。
</script>

<script id="anjianhuanjie-tpl-1" type="text/template">
         全省累计受理案件<span class="redcolor">!{crimeNum}</span>件；<br>
	立案<span class="redcolor">!{lianNum}</span>件；<br>
...
<script id="jierudanwei-tpl-2" type="text/template">
   	 全市接入公安机关<span class="redcolor">!{policeNum}</span>家，<br>
	市级<span class="redcolor">!{cityPoliceNum}</span>家，<br>
	县级<span class="redcolor">!{countyPoliceNum}</span>家。
</script>
...
<script id="jierudanwei-tpl-3" type="text/template">
   	全县 接入公安机关<span class="redcolor">!{policeNum}</span>家。<br>
</script>
...
<body onLoad="javascript:onLoad();" style=" background:#F4F9F8;">
 	<div class="xxtop">
		<div class="xxtop_logo">
			<img src="${path }/resources/images/topimages/logo.png" />
		</div>
		<!--xxtop_logo end-->
		<div class="xxtoplogoOth">
		<div class="xxtop_cen"
			onclick="addTab('','办案助手','${path}/system/accuseinfo/queryAccuseTypeTree')">
					...
					<li class="useryhLI"><a href="#" class="useryh">${currUser.userName }</a>
						<ul class="useryherjiUl">
							<li><a href="javascript:;"
								onclick="addTab('','个人信息修改','${path}/system/user/updateUI/head')">个人信息修改
							</a></li>
	...
	<div class="box" title="主页" >
    	<div class="boxcont">
        	<div class="boxcontleft">
            	<div class="daibananjian boxcont_mine boxcont_mine1">
                    ...
                    <div class="daibanaj_cont">
                        <div class="daibanajc_d" >
                        	<div class="dbajcd_left"><img src="${path }/resources/images/home/icon_daibanaj01.png" /></div>      
                          <div class="dbajcd_right">
                          	<div class="dbajword">	
                          	刑事案件<span class="redcolor">（<a href="javascript:;" onclick="addTab('454','待办案件','${path}/casehandle/caseTodo/list','10')" id="toDoNum"></a>）件</span><br/>
                          	行政拘留<span class="redcolor">（<a href="javascript:;" onclick="addTab('1000','行政拘留','${path}/casehandle/caseTodo/transferDetentionTodoList')" id="transferDetentionTodoNum"></a>）件</span><br/> 
                          	立案监督<span class="redcolor">（<a href="javascript:;" onclick="addTab('1001','立案监督','${path}/casehandle/caseTodo/lianSupTodoList')" id="lianSupTodoNum"></a>）件</span>
                          	</div>
                          </div>
                        </div>
                    </div>
	            ...
	            <div class="yujinganjian  boxcont_mine boxcont_mine2">                	
	                ...
	                <div class="daibanaj_cont">
                        <div class="daibanajc_d" >
                        	<div class="dbajcd_left yujing_left"><img src="${path }/resources/images/home/icons_yujingaj2.png" /></div>      
                          <div class="dbajcd_right">
                          	<div class="dbajword">
            ...
            <div class="boxcontright ">
                <!--yujinganjian end-->
                <div class="tongzhigonggao boxcont_mine boxcont_mine2" id="tongzhigonggao">                	
                	<div class="daibanaj_tit">
...
<%--         <div class="kuaijiecz">
            ...
            <div class="daibananjian  boxcont_mine boxcont_mine5 " id="kuaijieczdiv">
            	<div class="daibanaj_tit" id="kuaijieczdiv_tit">
               ...
               <div class="daibanaj_cont"  id="kuaijieczdiv_cont">
                    ...
                    <div class="kuaijieczdiv2" href="javascript:;" onclick="addTab('anjianbanli','涉嫌犯罪案件办理','${path}/casehandle/caseTodo/list','10')">
                    ...
                    <div class="kuaijieczdiv2" href="javascript:;" onclick="addTab('78','统计分析','${path}/breport/generalStats','266')">
                        ...
                        <!--yujingajLeft end-->
                        <div class="kuaijieczdiv_listname">统计分析
                        </div>                      
                  </div>
