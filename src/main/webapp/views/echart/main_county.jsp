...
<script type="text/javascript">
	...
	function loadAccuseChart() {
		...
		var regionId = "";
		$.ajax({
			url : "${path }/echart/accuseEchart?regionId=" + regionId
					+ "&yearCode=" + year,
			dataType : "json",
	...
	function loadIndustryTrendChartData() {
		...
		$("#industryTrendIndexSpan").text(indexName);
	...
	function loadCaseList(startTime, endTime, index, regionId) {
		...
		if (index == 'S') {
			...
			columns = [ {
				...
				display : '疑似涉嫌犯罪',
				name : 'SUSPECTED_CRIMINAL_NUM',
				textField : 'suspectedCriminalNum'
			} ];
		}
			...
			<div class="bar">
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<a href="#" id="show-industryTrendList" data-placement="bottom-right" 
						style="border:1px solid #90AABF;padding:0px 5px;cursor: pointer;text-decoration: none; color:#333; background-color: #fff;"
						 >行业：<span id="industryTrendListSpan" style="color:#D96D00; margin:0px 3px;">工商部门</span></a>
						<a href="#" id="show-industryTrendIndex" data-placement="bottom-right" 
						style="border:1px solid #90AABF;padding:0px 5px;cursor: pointer;text-decoration: none; color:#333; background-color: #fff;"
			...
			<tr>				
                ...
                <table width="500" border="0" class="zbTable">
				  ...
				  <tr>
				    ...
				    <td><input type="radio" name="indexList" value="J" /> <span>法院判决</span></td>
				  </tr>
<!-- 				  <tr>
				  ...
				  <tr>
				    <td scope="row"><input type="radio" name="indexList" value="R" /> <span>疑似涉嫌犯罪</span></td>
				    <td>&nbsp;</td>
				  </tr> -->
				</table>
				</td>
			...
			<tr>
                ...
                <table width="500" border="0" class="zbTable">
				  ...
				  <tr>
				    ...
				    <td><input type="radio" name="trendIndex" value="J" /> <span>法院判决</span></td>
				  </tr>
<!-- 				  <tr>
				  ...
				  <tr>
				    <td scope="row"><input type="radio" name="trendIndex" value="R" /> <span>疑似涉嫌犯罪</span></td>
				    <td>&nbsp;</td>
				  </tr> -->
				</table>
				</td>
			...
			<tr>
                ...
                <table width="500" border="0" class="zbTable">
				  ...
				  <tr>
				    ...
				    <td><input type="radio" name="industryIndex" value="J" /> <span>法院判决</span></td>
				  </tr>
<!-- 				  <tr>
				  ...
				  <tr>
				    <td scope="row"><input type="radio" name="industryIndex" value="R" /> <span>疑似涉嫌犯罪</span></td>
				    <td>&nbsp;</td>
				  </tr> -->
				</table>
				</td>
			...
			<tr>
                ...
                <table width="500" border="0" class="zbTable">
				  ...
				  <tr>
				    ...
				    <td><input type="radio" name="industryTrendIndex" value="J" /> <span>法院判决</span></td>
				  </tr>
<!-- 				  <tr>
				  ...
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendIndex" value="R" /> <span>疑似涉嫌犯罪</span></td>
				    <td>&nbsp;</td>
				  </tr> -->
				</table>
				</td>
	...
	<div id="industryTrendListContent" style="display:none;">		
		<table id="industryTrendIndexTable" cellpadding="0" style="width: 99%" cellspacing="0">
			<tr>
				<td style="width: 100%;" align="left">
                <table width="500" border="0" class="zbTable">
				  <tr>
				    <td scope="row" style=" width:50%;"><input type="radio" name="industryTrendList" value="JIAOTONG"/><span>交通部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="JINGXIN" /> <span>经信委</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="LIANGSHI" /> <span>粮食部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="JIAOYU" /> <span>教育部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="HUANBAO" /> <span>环保部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="TONGJI" /> <span>统计部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="GUOFANG" /> <span>国防办</span></td>
				    <td><input type="radio" name="industryTrendList" value="MINZHENG" /> <span>民政部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="WUJIA" /> <span>物价部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="NONGYE"  checked="checked" /> <span>农业部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="WEISHENG" /> <span>卫生部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="GUOZI" /> <span>国资委</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="WENTI" /> <span>新闻出版广电部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="LVYOU" /> <span>旅游部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="SHUILI" /> <span>水利部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="ANJIAN" /> <span>安全生产监督管理部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="RENSHE" /> <span>人社部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="SHANGWU" /> <span>商务部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="GONGSHANG" /> <span>工商部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="SHIYAOJIAN" /> <span>食药监部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="ZHIJIAN" /> <span>质检部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="TIYU" /> <span>体育部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="GUOTU" /> <span>国土部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="LINYE" /> <span>林业部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="WEHHUA" /> <span>文化部门</span></td>
				    <td><input type="radio" name="industryTrendList" value="SHENJI" /> <span>审计部门</span></td>
				  </tr>
				  <tr>
				    <td scope="row"><input type="radio" name="industryTrendList" value="MINZONG" /> <span>民族宗教事务部门</span></td>
				    <td>&nbsp;</td>
				  </tr>
				</table>
				</td>
