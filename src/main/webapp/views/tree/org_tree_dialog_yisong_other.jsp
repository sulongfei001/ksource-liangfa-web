	...
	<script src="${path }/resources/jquery/zTree/jquery.ztree-2.6.min.js"></script>
 	<script type="text/javascript">
		...
		$(function(){
 		   ...
 		   //heightChanged();
 		   handleSelects();
 		   $("#orgListFrame").attr("src","${path}/system/org/orgTreeYiSongOtherList?isSingle=${isSingle }&flag=${flag }");
		});
		...
		function districtTreeOnClick(event, treeId, treeNode){
			if (treeNode) {
			var url="${path}/system/org/orgTreeYiSongOtherList?districtCode="+treeNode.id+"&isSingle="+isSingle+"&flag="+flag;
