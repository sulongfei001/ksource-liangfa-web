...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function loadDaibanCount() {
			var url = "${path}/home/portal/daibanData_jianchaju";
			$.post(url, function(data) {
				var obj = eval('(' + data + ')');
				$("#caseYisongNum").text(obj.caseYisongNum);
			});
		}
	...
	<script id="jierudanwei-tpl-1" type="text/template">
		全省接入监察局<span class="redcolor">!{jianchajuNum}</span>家，<br> 省级
		<span class="redcolor">!{proviceJianchajuNum}</span>家，<br> 市级
		<span class="redcolor">!{cityJianchajuNum}</span>家，<br> 县级
		<span class="redcolor">!{countyJianchajuNum}</span>家。
	</script>

	<script id="anjianhuanjie-tpl-1" type="text/template">
		全省累计受理案件<span class="redcolor">!{crimeNum}</span>件；<br> 立案
		<span class="redcolor">!{lianNum}</span>件；<br> 提请逮捕
		<span class="redcolor">!{tiqingdaibuNum}</span>件，<span class="redcolor">!{tiqingdaibuPersonNum}</span>人；<br> 批准逮捕
		<span class="redcolor">!{daibuNum}</span>件，<span class="redcolor">!{daibuPersonNum}</span>人；<br> 移送起诉
		<span class="redcolor">!{tiqingqisuPersonNum}</span>件，<span class="redcolor">!{tiqingqisuPersonNum}</span>人。<br>
	</script>

	<script id="jierudanwei-tpl-2" type="text/template">
		全市接入监察局<span class="redcolor">!{jianchajuNum}</span>家，<br> 市级
		<span class="redcolor">!{cityJianchajuNum}</span>家，<br> 县级
		<span class="redcolor">!{countyJianchajuNum}</span>家。
	</script>

	<script id="anjianhuanjie-tpl-2" type="text/template">
		全市累计受理案件<span class="redcolor">!{crimeNum}</span>件；<br> 立案
		<span class="redcolor">!{lianNum}</span>件；<br> 提请逮捕
		<span class="redcolor">!{tiqingdaibuNum}</span>件，<span class="redcolor">!{tiqingdaibuPersonNum}</span>人；<br> 批准逮捕
		<span class="redcolor">!{daibuNum}</span>件，<span class="redcolor">!{daibuPersonNum}</span>人；<br> 移送起诉
		<span class="redcolor">!{tiqingqisuPersonNum}</span>件，<span class="redcolor">!{tiqingqisuPersonNum}</span>人。<br>
	...
	<script id="jierudanwei-tpl-3" type="text/template">
		全县接入监察局<span class="redcolor">!{jianchajuNum}</span>家。<br>
	</script>

	<script id="anjianhuanjie-tpl-3" type="text/template">
		累计受理案件<span class="redcolor">!{crimeNum}</span>件；<br> 立案
		<span class="redcolor">!{lianNum}</span>件；<br> 提请逮捕
		<span class="redcolor">!{tiqingdaibuNum}</span>件，<span class="redcolor">!{tiqingdaibuPersonNum}</span>人；<br> 批准逮捕
		<span class="redcolor">!{daibuNum}</span>件，<span class="redcolor">!{daibuPersonNum}</span>人；<br> 移送起诉
		<span class="redcolor">!{tiqingqisuPersonNum}</span>件，<span class="redcolor">!{tiqingqisuPersonNum}</span>人。<br>
			...
			<div class="xxtoplogoOth">
				...
				<div class="xxtop_right">
					...
					<div class="xxtop_nav">
						<ul>
							<li class="useryhLI">
								<a href="#" class="useryh">${currUser.userName }
								</a>
								<ul class="useryherjiUl">
									<li>
										<a href="javascript:;" onclick="addTab('','个人信息修改','${path}/system/user/updateUI/head')">个人信息修改
										</a>
									</li>
		...
		<div id="layout1">
			...
			<div position="center" id="framecenter">
				<div class="box" title="主页">
					<div class="boxcont">
						<div class=" daibananjian boxcontleft boxcont_mine">
							...
							<div class="daibanaj_cont">
								<div class="daibanajc_d" href="javascript:;" onclick="addTab('250','移送违纪案件','${path}/workflow/task/caseYisongExamine','239')">
									<div class="dbajcd_left" id="sxfzbjcolor"><img src="${path }/resources/images/home/icon_sxfzaj02.png" /></div>
									<!--dbajcd_left end-->
									<div class="dbajcd_right">
										<div class="dbajword">移送违纪案件 <br /> <span class="redcolor">（<a href="javascript:;" id="caseYisongNum"></a>）件</span> </div>
									</div>
									<!--dbajcd_right end-->
								</div>
								<!--daibanajc_d end-->
						...
						<!--boxcontleft end-->
						<div class="boxcontright yujinganjian boxcont_mine" id="tongzhigonggao">
							<!--yujinganjian end-->
							<div class="daibanaj_tit">
...
<%-- 					<div class="clear"></div>
					<div class="kuaijiecz">
						...
						<div class="boxcont_mine" id="kuaijieczdiv"  style="background: #fff;">
