...
$(function(){
	...
	function search() {
		...
		$('#findForm')[0].action = "${path}/breport/generalIndustryStats?indexList="
				+ index;
		$('#findForm').submit();
	}
...
<legend class="legend">案件办理环节统计(按行业)</legend>
<form action="" id="findForm" method="post">
	<table width="100%" class="searchform">
			<tr>
				...
				<input type="text" class="text" id="districtId" name="districtName" value="${districtName}" onfocus="showMenu(); return false;" readonly="readonly" />				 <input type="hidden" name="districtId" id="districtId_hidden" value="${districtId}" /> <a href="#" onclick="clearDiv()" class="aQking qingkong">清空</a></td>
				<td width="15%" align="right">
				   案件录入时间
				</td>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_industryStats.raq"
					funcBarLocation=""
					needPageMark="yes"
                    ...
                    needSaveAsPdf="yes" needSaveAsWord="yes" pdfExportStyle="text,0"
									 ...
									 needSelectPrinter="yes" savePrintSetup="yes" displayNoLinkPageMark="yes" saveAsName="案件办理环节统计(按行业)"
				/>
			</td>
		</tr>
	</table>
