...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByQuarter?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
	...
	function report1_back(){
		...
		var indexList='${index}';
		window.location.href="${path }/breport/caseFilterStatsByYear?districtId="+districtId+"&indexList="+indexList;
	}
</script>
<style>
...
<legend class="legend">降格处理案件线索统计(按季度)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByQuarter.raq"
					funcBarLocation=""
					needPageMark="yes"
