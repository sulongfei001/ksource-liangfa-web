...
$(function(){
	...
	function search(){
		 $('#findForm')[0].action="${path}/breport/accuseYearStats";
		 $('#findForm').submit();                
	}
...
<legend class="legend">罪名统计(按年度)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_accuseYearStats.raq"
					funcBarLocation=""
					needPageMark="yes"
                    ...
                    needSaveAsPdf="yes" needSaveAsWord="yes" pdfExportStyle="text,0"
									 ...
									 needSelectPrinter="yes" savePrintSetup="yes" displayNoLinkPageMark="yes" saveAsName="罪名统计(按年度)"
				/>
			</td>
		</tr>
	</table>
