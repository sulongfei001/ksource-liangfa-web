...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByRegionCity?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
...
<legend class="legend">线索筛查案件汇总统计(按区划)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByRegionCity.raq"
					funcBarLocation=""
					needPageMark="yes"
