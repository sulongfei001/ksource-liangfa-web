...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByMonth?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
	...
	function report1_back(){
		var indexList='${index}';
		window.location.href="${path}/breport/caseFilterStatsByQuarter?yearCode="+${yearCode}+"&districtId="+${districtId}+"&indexList="+indexList;
	}
</script>
<style>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByMonth.raq"
					funcBarLocation=""
					needPageMark="yes"
