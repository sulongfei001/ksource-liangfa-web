...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/generalStatsQuarter?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
	...
	function report1_back(){
		...
		window.location.href="${path }/breport/generalStatsYear?districtId="+districtId+"&indexList="+indexList+"&districtQueryScope="+districtQueryScope;
	}
</script>
<style>
...
<legend class="legend">案件办理环节统计(按季度)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_gengralStatsByQuarter.raq"
					funcBarLocation=""
					needPageMark="yes"
                    ...
                    needSaveAsPdf="yes" needSaveAsWord="yes" pdfExportStyle="text,0"
									 ...
									 needSelectPrinter="yes" savePrintSetup="yes" displayNoLinkPageMark="yes" saveAsName="案件办理环节统计(按季度)"
				/>
			</td>
		</tr>
	</table>
