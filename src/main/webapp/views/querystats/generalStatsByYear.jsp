...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/generalStatsYear?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
...
<legend class="legend">案件办理环节统计(按年度)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_gengralStatsByYear.raq"
					funcBarLocation=""
					needPageMark="yes"
                    ...
                    needSaveAsPdf="yes" needSaveAsWord="yes" pdfExportStyle="text,0"
									 ...
									 needSelectPrinter="yes" savePrintSetup="yes" displayNoLinkPageMark="yes" saveAsName="案件办理环节统计(按年度)"
				/>
			</td>
		</tr>
	</table>
