...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByIndustryCity?indexList="+index;
		 $('#findForm').submit();                
	}
...
<legend class="legend">线索筛查案件汇总统计(按行业)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByIndustryCity.raq"
					funcBarLocation=""
					needPageMark="yes"
