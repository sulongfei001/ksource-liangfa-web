...
function search(){
	 $('#findForm')[0].action="${path}/accuseStats/caseAccuseStats";
	 $('#findForm').submit();                
}
</script>
<style>
...
<legend class="legend">案件罪名统计</legend>
<form action="" id="findForm" method="post">
	...
	<table width="100%" style="text-align: left;">
		<tr>
			<td>
				<report:html name="report1" reportFileName="caseAccuseStats.raq"
					funcBarLocation=""
					needPageMark="yes"
					...
					width="-1"
                     needSaveAsPdf="yes" needSaveAsWord="yes" pdfExportStyle="text,0"
									 ...
									 needSelectPrinter="yes" savePrintSetup="yes" displayNoLinkPageMark="yes" saveAsName="案件罪名统计"
				/>
			</td>
		</tr>
	</table>
