...
$(function(){
	...
	function search(){
		 $('#findForm')[0].action="${path}/breport/accuseIndustryOrgStats";
		 $('#findForm').submit();                
	}
	...
	function report1_back(){
		...
		window.location.href="${path }/breport/accuseIndustryStats?districtId="+districtId+"&startTime="+startTime+"&endTime="+endTime;
	}
</script>
<style>
...
<legend class="legend">罪名统计(按行业)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_accuseIndustryOrgStats.raq"
					funcBarLocation=""
					needPageMark="yes"
                    ...
                    needSaveAsPdf="yes" needSaveAsWord="yes" pdfExportStyle="text,0"
									 ...
									 needSelectPrinter="yes" savePrintSetup="yes" displayNoLinkPageMark="yes" saveAsName="罪名统计(按行业)"
				/>
			</td>
		</tr>
	</table>
