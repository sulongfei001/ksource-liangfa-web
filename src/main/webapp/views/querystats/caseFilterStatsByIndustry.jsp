...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByIndustry?indexList="+index;
		 $('#findForm').submit();                
	}
...
<legend class="legend">降格处理案件线索统计(按行业)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByIndustry.raq"
					funcBarLocation=""
					needPageMark="yes"
