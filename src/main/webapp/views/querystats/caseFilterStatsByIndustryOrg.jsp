...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByIndustryOrg?indexList="+index;
		 $('#findForm').submit();                
	}
	...
	function report1_back(){
		window.location.href="${path}/breport/caseFilterStatsByIndustry?districtId=${districtId}&indexList=${index}&startTime=${startTime}&endTime=${endTime}";
	}
</script>
<style>
...
<legend class="legend">线索筛查案件统计汇总表(按行业)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByIndustryOrg.raq"
					funcBarLocation=""
					needPageMark="yes"
