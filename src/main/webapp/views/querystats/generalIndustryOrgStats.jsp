...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/generalIndustryOrgStats?indexList="+index;
		 $('#findForm').submit();                
	}
	...
	function report1_back(){
		window.location.href="${path}/breport/generalIndustryStats?districtId=${districtId}&indexList=${index}&startTime=${startTime}&endTime=${endTime}";
	}
</script>
<style>
...
<input type="hidden" name="industryType" id="industryType" value="${industryType}"/>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_industryOrgStats.raq"
					funcBarLocation=""
					needPageMark="yes"
