...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/districtLevelStats?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
	...
	function report1_back(){
		window.location.href="${path}/breport/districtLevelStats?districtId=${queryDistrictId}&indexList=${index}&startTime=${startTime}&endTime=${endTime}";
	}
</script>
<style>
...
<legend class="legend">案件办理环节统计(按层级)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_districtLevelStatsByOrg.raq"
					funcBarLocation=""
					needPageMark="yes"
