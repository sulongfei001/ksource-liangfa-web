...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByYear?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
...
<legend class="legend">降格处理案件线索统计(按年度)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByYear.raq"
					funcBarLocation=""
					needPageMark="yes"
