...
<script type="text/javascript">
	...
	function report1_back(){
		...
		var isDqdj='${isDqdj}';
		window.location.href = "${path}/breport/o_custom_stats.do?showReport="+showReport+
				"&indexList="+indexList+"&districtId="+districtId+"&isDqdj="+isDqdj;		
	}
</script>
<style type="text/css">
.btn_small {
					...
					<table width="100%" align="center">
						<tr>
							...
							<jsp:include page="/quiee/reportJsp/toolbar.jsp" flush="false" />
								<report:html name="report1" srcType="file" reportFileName="custom_quarter_stats.raq" params="${parameter}" 
								funcBarLocation="" 
