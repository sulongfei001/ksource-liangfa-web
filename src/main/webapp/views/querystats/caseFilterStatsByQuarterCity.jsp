...
$(function(){
	...
	function search(){
		 ...
		 $('#findForm')[0].action="${path}/breport/caseFilterStatsByQuarterCity?indexList="+index;
		 $('#findForm').submit();                
	}
	$(function(){
		hiddenDIV();
	...
	function report1_back(){
		...
		var indexList='${index}';
		window.location.href="${path }/breport/caseFilterStatsByYearCity?districtId="+districtId+"&indexList="+indexList;
	}
</script>
<style>
...
<legend class="legend">立案监督线索统计(按季度)</legend>
	...
	<table align="center" style="width: 100%;">
		<tr>
			<td align="right">
				...
				<report:html name="report1" reportFileName="business_caseFilterStatsByQuarterCity.raq"
					funcBarLocation=""
					needPageMark="yes"
