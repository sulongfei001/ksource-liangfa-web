		...
		jqueryUtil.formValidate({
	    	...
	    	rules:{
	    		programaName:{
	    			...
	    			maxlength:25,
	    			remote:{
	    				url:'${path}/website/maintain/webPrograma/checkName',
	    			    type:'post',
	    			    data:{
...
<div class="panel">
	<form:form id="addForm" action="${path }/website/maintain/webPrograma/update">
		<input type="hidden" id="programaId" name="programaId" value="${webPrograma.programaId }"/>
		<table width="90%" class="table_add">
			<tr>
				<td align="right" style="width: 40%">栏目名称：</td>
				<td>
					<input type="text" class="text" name="programaName" value="${webPrograma.programaName }"/>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td align="right" style="width: 40%">栏目在首页的位置：</td>
				<td>
					<input type="text" class="text" name="homeLocation" value="${webPrograma.homeLocation }"/>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
				<td align="right" style="width: 40%">栏目在导航条排序：</td>
				<td>
					<input type="text" class="text" name="navigationSort" value="${webPrograma.navigationSort }"/>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
