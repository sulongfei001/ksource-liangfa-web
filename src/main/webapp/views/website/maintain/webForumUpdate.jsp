...
<script type="text/javascript">
	$(function(){
		...
		jqueryUtil.formValidate({
	    	...
	    	blockUI:false,
	    	rules:{
	    		navigationSort:{required:true,digits:true,range:[4,7],
	    			remote:{
	    				url:'${path}/website/maintain/webForum/checkSort',
	    			    type:'post',
	    			    data:{
	    			    	forumId:function(){return $('#forumId').val();}
	    			    }
	    			}
	    		}
	    	},
...
<body>
<div class="panel">
	<form:form id="addForm" action="${path }/website/maintain/webForum/update">
		<input type="hidden" id="forumId" name="forumId" value="${webForum.forumId }">
		<table style="width: 90%;" class="table_add">
			<tr>
				<td class="tabRight" style="width: 40%">论坛模块名称：</td>
				<td align="left" width="60%">
					<input type="text" class="text" disabled="disabled" value="${webForum.name }">
				</td>
			</tr>
			<tr>
				<td class="tabRight" style="width: 40%">论坛模块在导航条排序：</td>
				<td align="left" width="60%">
					<input type="text" class="text" name="navigationSort" value="${webForum.navigationSort }"/>&nbsp;<font color="red">*</font>
				</td>
			</tr>
			<tr>
