...
<div class="panel">
	<form:form id="addForm" action="${path }/website/maintain/webArticleType/add">
		<table style="width: 90%;" class="table_add">
			<tr>
				<td class="tabRight" width="30%">所属栏目：</td>
				<td align="left" width="70%">
					<input type="text" class="text" name="programaName" id="programaName" onfocus="showMenu(); return false;" readonly="readonly"/>
					<input type="hidden" name="programaId" id="programaId" class="text"/>
