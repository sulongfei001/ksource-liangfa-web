...
<div class="lfltmenunew2"><h3 class="fl">通知公告</h3></div>
<div class="sjz_listcont1">
<div id="notice">
	<display:table name="notices" uid="notice" requestURI="${path }/website/explore/selectNoticeMain">
		<display:column class="w620">
			<a href="javascript:;" onclick="webNoticeDetail(${notice.noticeId },${searchId})" title="${notice.noticeTitle}">${fn:substring(notice.noticeTitle,0,30)}${fn:length(notice.noticeTitle)>30?'...':''}</a>
		</display:column>
