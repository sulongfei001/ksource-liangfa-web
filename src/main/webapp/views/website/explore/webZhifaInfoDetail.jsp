...
<div class="lfltmenunew2"><h3>执法动态</h3></div>
<div class="sjz_listcont1 detailcont">
<h3>${zhifaInfo.title }</h3>
<div class="time"><span class="fl textright">发表日期：<fmt:formatDate value="${zhifaInfo.createTime }" pattern="yyyy-MM-dd"/></span>    <span class="fr">撰文：${user.userName }</span> <div class="clear"></div></div>
${zhifaInfo.content }
</div>
