...
<div>
<p class="address">你所在的位置：<a class="font_12_0075b8" href="javascript:home(1);">首页</a> >> 执法动态</p>
<div class="sjz_w739 fl">
<div class="lfltmenunew2"><h3 class="fl">执法动态</h3></div>
<div class="sjz_listcont1">
<div id="zhifaInfo">
	<display:table name="zhifaInfos" uid="zhifaInfo" requestURI="${path }/website/explore/selectZhifaInfoMain">
		<display:column class="w620">
			<a href="javascript:;" onclick="webZhifaInfoDetail(${zhifaInfo.infoId },8,${searchId})" title="${zhifaInfo.title}">${fn:substring(zhifaInfo.title,0,30)}${fn:length(zhifaInfo.title)>30?'...':''}</a>
		</display:column>
		<display:column class="w80">
			[<fmt:formatDate value="${zhifaInfo.createTime }" pattern="yyyy-MM-dd" />]
		</display:column>
	</display:table>
</div>
</div>
