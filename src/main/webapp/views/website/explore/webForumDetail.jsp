...
<div class="lfltmenunew2"><h3>${forumCommunity.name }</h3></div>
<div class="sjz_listcont1 detailcont">
<h3>${forumTheme.name }</h3>
<div class="time"><span class="fl textright">发表日期：<fmt:formatDate value="${forumTheme.createTime }" pattern="yyyy-MM-dd"/></span>    <span class="fr gly">撰文：${user.userName }</span> <div class="clear"></div></div>
${forumTheme.content }
</div>
