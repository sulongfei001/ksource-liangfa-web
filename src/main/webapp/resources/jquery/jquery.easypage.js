	...
	function($){
		$.extend({
				"easypage":function(options){
					...
					//拼接导航按钮
					var navigatehtml = "<ul><div id='pagefirst' class='pagefirst'><li><a href='javascript:void(0)'>首页</a></li></div><div id='pagepre' class='pagepre'><li><a href='javascript:void(0)'>上一页</a></li></div>";
					for(var i = 1;i <= pagecount;i++){
							navigatehtml+='<div class="pagenavigate"><li><a href="javascript:void(0)">'+i+'</a></li></div>';
					}
					navigatehtml+="<div id='pagenext' class='pagenext'><li><a href='javascript:void(0)'>下一页</a></li></div><div id='pagelast' class='pagelast'><li><a href='javascript:void(0)'>尾页</a></li></div></ul>";
