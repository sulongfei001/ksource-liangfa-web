...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
                     ["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink",
                      "link","cleardoc","selectall","print","searchreplace",
                      "preview","|","inserttable","deletetable","mergeright",
                      "mergedown","splittorows","splittocols","splittocells",
                      "mergecells","insertcol","insertrow","deletecol",
                      "deleterow","insertparagraphbeforetable","bold",
                      ...
                      "imagecenter","insertimage","attachment","date","time","horizontal",
                      "spechars","blockquote","pagebreak","background"
                     ]
                    ]
