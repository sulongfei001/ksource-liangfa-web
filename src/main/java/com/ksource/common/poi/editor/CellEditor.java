...
import com.ksource.common.poi.ExcelContext;
import com.ksource.common.poi.editor.font.BoldFontEditor;
import com.ksource.common.poi.editor.font.FontColorEditor;
import com.ksource.common.poi.editor.font.FontHeightEditor;
import com.ksource.common.poi.editor.font.ItalicFontEditor;
import com.ksource.common.poi.editor.listener.CellValueListener;
import com.ksource.common.poi.style.Align;
import com.ksource.common.poi.style.BorderStyle;
import com.ksource.common.poi.style.Color;
import com.ksource.common.poi.style.FillPattern;
import com.ksource.common.poi.style.VAlign;
...
//		return this;
	...
	/**
	 * 依次设置所有单元格的宽度
	 * @param widths 宽，1表示一个字符好宽度的1/256
	 * @return
	 */
	...
	private Object getCellValue(HSSFCell cell){
        ...
        case HSSFCell.CELL_TYPE_NUMERIC:
            //解决poi不能解析2012年2月2日的日期格式(重写了 poi中DateUti.isCellDateFormatted方法)
            ...
            if ( DateUtil.isValidExcelDate(d) ) {
                ...
                bDate = HSSFDateUtil.isADateFormat(i, fs);
            }
            if (bDate) {
