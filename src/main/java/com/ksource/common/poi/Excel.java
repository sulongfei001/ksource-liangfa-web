...
import com.ksource.common.poi.editor.CellEditor;
import com.ksource.common.poi.editor.ColumnEditor;
import com.ksource.common.poi.editor.RegionEditor;
import com.ksource.common.poi.editor.RowEditor;
import com.ksource.common.poi.editor.SheetEditor;
import com.ksource.common.poi.util.ExcelUtil;
...
public class Excel {
    ...
    /**
	 * 用一个Excel文件流作为模板创建一个Excel，如果模板文件不存在则创建一个空Excel文件
	 *  (add by zxl)
	 * @param input
	 *            模板文件路径，可以是文件绝对路径如C：/excel.xls，或classpath里的文件，如/wsepr/easypoi/excel/test/excel.xls
	 */
	public Excel(InputStream input) {
