 ...
 * time   下午02:24:09
 */
public class LuceneFactoryForHotline {
    public static final Version LUCENE_VERSION = Version.LUCENE_33;
    public static String SESSION_QUERY_FLAG = LuceneFactoryForHotline.class.getName() +
        "query_flag";
    public static final String HIGHLIGH_FLAG_START = "<em>";
    public static final String HIGHLIGH_FLAG_END = "</em>";
    public static final String INDEX_HOTLINE_FILE_PATH="resources/index/hotline";
    ...
    private static Query createParseQuery(Entry<String, Object> entry){
         try {
			return IKQueryParser.parseMultiField(new String[]{"theme","content"},entry.getValue().toString());
		} catch (IOException e) {
			e.printStackTrace();
		}
		return null;
    ...
    public static IndexWriter getHotlineIndexWriter() {
    	IndexWriter writer=null;
    	try{
    		Directory dir = getHotlineLuceneDirectory();
	...
	public static Directory getHotlineLuceneDirectory(){
		String realpath = getHotlineRealPath();
	...
	private static String getHotlineRealPath() {
		String separator = "/";
		String separatorTwo ="\\\\";
		String savePath = INDEX_HOTLINE_FILE_PATH;
