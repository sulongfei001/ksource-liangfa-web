...
@Controller
@RequestMapping("casehandle/myCaseFenpai")
public class MyCaseFenpaiController {

	private static final String CASE_TURNOVER_LIST="casehandle/myCaseFenpai/myCaseFenpaiList";
	...
	public ModelAndView list(HttpServletRequest request,
		...
		caseBasic.setFenpaiOrg(orgId);
		caseBasic.setIsAssign(Const.IS_ASSIGN_YES);
		PaginationHelper<CaseBasic> myCaseFenpaiList = caseService.findMyCaseFenpai(caseBasic, page);
		//不为空时，则查询预警信息
    	for(CaseBasic ct:myCaseFenpaiList.getList()){
    		//涉案当事人历史案件预警
    	...
    	mv.addObject("myCaseFenpaiList", myCaseFenpaiList);
